 ...
 *                                NI-Sync
 *---------------------------------------------------------------------------
 *   Copyright (c) National Instruments 2003-__CURRENT_YEAR__.  All Rights Reserved.
 *---------------------------------------------------------------------------
 *
 * Title:    niSync.h
 * Purpose:  NI-Sync
...
#define NISYNC_ATTR_1588_OFFSET_SCALED_LOG_VARIANCE  (NISYNC_ATTR_BASE + 752L)  /* ViInt32 */
#define NISYNC_ATTR_1588_LEAP59                      (NISYNC_ATTR_BASE + 763L)  /* ViBoolean */
#define NISYNC_ATTR_1588_LEAP61                      (NISYNC_ATTR_BASE + 764L)  /* ViBoolean */
#define NISYNC_ATTR_1588_TIME_TRACEABLE              (NISYNC_ATTR_BASE + 765L)  /* ViBoolean */
#define NISYNC_ATTR_1588_FREQUENCY_TRACEABLE         (NISYNC_ATTR_BASE + 766L)  /* ViBoolean */
#define NISYNC_ATTR_1588_TIME_SOURCE                 (NISYNC_ATTR_BASE + 768L)  /* ViInt32 */
...
#define NISYNC_ATTR_TIMEREF_CURRENT          (NISYNC_ATTR_BASE + 801L)
...
/* 1588 Clock Class Definitions */
#define NISYNC_VAL_1588_CLK_CLASS_DEFAULT (248)
...
#define NISYNC_VAL_1588_TIME_SOURCE_UNKNOWN               (0)
#define NISYNC_VAL_1588_TIME_SOURCE_ATOMIC_CLOCK          (1)
#define NISYNC_VAL_1588_TIME_SOURCE_GPS                   (2)
#define NISYNC_VAL_1588_TIME_SOURCE_TERRESTRIAL_RADIO     (3)
#define NISYNC_VAL_1588_TIME_SOURCE_PTP                   (4)
#define NISYNC_VAL_1588_TIME_SOURCE_NTP                   (5)
#define NISYNC_VAL_1588_TIME_SOURCE_HAND_SET              (6)
#define NISYNC_VAL_1588_TIME_SOURCE_OTHER                 (7)
#define NISYNC_VAL_1588_TIME_SOURCE_INTERNAL_OSCILLATOR   (8)
#define NISYNC_VAL_1588_TIME_SOURCE_ALTERNATE_PTP         (9)
#define NISYNC_VAL_1588_TIME_SOURCE_RESERVED              (10)
...
#define NISYNC_ERRMSG_LIB_LOAD_FAILURE "Unable to load an internal library. If the error persists contact NI support."
...
#define NISYNC_ERRMSG_COMMUNICATIONS_FAULT "A failure occured while communicating with a required software service running on the device. Restart the device. If the error persists, contact NI support."
